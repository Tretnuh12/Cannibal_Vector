...
if gamepad_button_check_pressed(0,gp_B) instance_create_layer(x,y,"lay_shield",obj_shield)
if gamepad_button_check_released(0,gp_B) instance_destroy(obj_shield)
if gamepad_button_check_pressed(0,gp_X) instance_create_layer(x,y,"instances",obj_spear) 
//change sprite under circumstances
if gamepad_button_check_pressed(0,gp_X)
{
	sprite_index = atck;
}
if gamepad_button_check_released(0,gp_X)
{
